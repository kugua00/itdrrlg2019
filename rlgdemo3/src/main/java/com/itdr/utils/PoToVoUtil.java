...
public class PoToVoUtil {
    ...
    public static CartProductVO getOne(Carts cart, Products p){
        //封装cartProductVo
    ...
    /*商品详情和支付宝商品类转换*/
    public static PGoodsDetail getNewPay(OrderItems orderItem){
    ...
    /*获取一个BizContent对象*/
    public static BizContent getBizContent(Orders order, List<OrderItems> orderItems){
        ...
        for (OrderItems or : orderItems) {
            ...
            GoodsDetail goods = getNewPay(or);
            // 创建好一个商品后添加至商品明细列表
